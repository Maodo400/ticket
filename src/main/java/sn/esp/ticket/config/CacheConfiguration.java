...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, sn.esp.ticket.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, sn.esp.ticket.repository.UserRepository.USERS_BY_EMAIL_CACHE);
